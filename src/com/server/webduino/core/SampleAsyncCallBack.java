...
public class SampleAsyncCallBack implements MqttCallback {
	...
	public interface SampleAsyncCallBackListener {

		void messageReceived(String topic, String message);
	}

	protected List<SampleAsyncCallBackListener> listeners = new ArrayList<>();

	public void addListener(SampleAsyncCallBackListener toAdd) {
		listeners.add(toAdd);
	}
...
//    	}
	...
	public void messageArrived(String topic, MqttMessage message) throws MqttException {
		...
		String payloadMessage = new String(message.getPayload());
		System.out.println("Time:\t" +time +
                           "  Topic:\t" + topic +
                           "  Message:\t" + payloadMessage +
                           "  QoS:\t" + message.getQos());

		for (SampleAsyncCallBackListener listener : listeners) {
